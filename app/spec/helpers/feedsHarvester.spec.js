...
var fs = require('fs');
var fh = require('../../helpers/feedsHarvester');

var atomXml = fs.readFileSync('./spec/data/atom.xml');
var rss2Xml = fs.readFileSync('./spec/data/rss2.xml');
var isoEncoded = fs.readFileSync('./spec/data/iso-encoded.xml');
...
describe('feedsHarvester feed url discovery', function () {
...
describe('feedsHarvester feed content fetching', function () {
